    ...
    >
      ...
      >
        ...
        {anchorStates.syntaxia && (
          <div className="row-start-1 col-start-3 text-[0.9rem] text-center normal-case tracking-[0.01em] invisible lg:visible border border-b-4 border-description-boxes border-emerald-900 bg-teal-500 text-emerald-200 px-4">
            <p>Official registration website for Syntaxia 2023.</p>
            <p>Built with <span className="font-bold underline underline-offset-4">HTML, CSS, JavaScript & Bootstrap</span>.</p>
            <p>Hosted with <span className="font-bold">Firebase</span>.</p>
          </div>
        )}
        <a
        ...
        {anchorStates.loyola && (
          <div className="row-start-2 col-start-3 text-[0.9rem] text-center normal-case tracking-[0.01em] invisible lg:visible border border-b-4 border-description-boxes border-emerald-900 bg-teal-500 text-emerald-200 px-4">
            <p>Redesigned website for Loyola Degree College.</p>
            <p>Built with <span className="font-bold underline underline-offset-4">Next.js, React & Tailwind CSS</span>.</p>
            <p>Hosted with <span className="font-bold">Vercel</span>.</p>
          </div>
        )}
        <a
        ...
        {anchorStates.todo && (
          <div className="row-start-3 col-start-3 text-[0.9rem] text-center normal-case tracking-[0.01em] invisible lg:visible border border-b-4 border-description-boxes border-emerald-900 bg-teal-500 text-emerald-200 px-4">
            <p>Simple To-Do app.</p>
            <p>Built with <span className="font-bold underline underline-offset-4">React & Tailwind CSS</span>.</p>
            <p>Hosted with <span className="font-bold">Cloudflare Pages</span>.</p>
          </div>
        )}
        <a
        ...
        {anchorStates.milestone && (
          <div className="row-start-4 col-start-3 text-[0.9rem] text-center normal-case tracking-[0.01em] invisible lg:visible border border-b-4 border-description-boxes border-emerald-900 bg-teal-500 text-emerald-200 px-4">
            <p>A cataloguing app for university faculty.</p>
            <p>Built with <span className="font-bold underline underline-offset-4">Next.js, Supabase & Tailwind CSS</span>. Hosted with <span className="font-bold">Vercel</span>.</p>
          </div>
        )}
        <a
        ...
        <div className="row-start-5 col-span-3 -mt-6 pb-4 lg:mt-0 lg:pb-0 lg:row-start-6 lg:col-span-1 lg:col-start-2 text-xs text-center normal-case tracking-[0.01em]">
            <p>This website was built with <span className="font-bold whitespace-pre lg:whitespace-normal">
              Vite, React & Tailwind CSS.</span></p>
          </div>
      </div>
    </div>
  );
