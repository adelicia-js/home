...
export default function AboutMe() {
  return (
    ...
    >
      <h1 className={`text-4xl font-bold pb-4`}>Hi! :{`)`} I{`'`}m Ady.</h1>
      <h2 className={`text-l pb-1`}>A graduate student from Bengaluru, India.</h2>
      <h2 className={`text-l pb-4`}>Also a frontend web developer, artist & cat enthusiast.</h2>
